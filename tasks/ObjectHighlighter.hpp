...
#ifndef SIMULATION_OBJECTHIGHLIGHTER_TASK_HPP
#define SIMULATION_OBJECTHIGHLIGHTER_TASK_HPP

#include "mars/ObjectHighlighterBase.hpp"
...
namespace mars {
   ...
   */
  class ObjectHighlighter : public ObjectHighlighterBase
  {
    friend class ObjectHighlighterBase;
    ...
    public:
       ...
       */
      ObjectHighlighter(std::string const& name = "mars::RobotTeleportation");
       ...
       *
       */
      ObjectHighlighter(std::string const& name, RTT::ExecutionEngine* engine);
